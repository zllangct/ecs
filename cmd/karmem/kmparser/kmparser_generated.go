...
var _Null_kmparser = [64]byte{}
var _NullReader_kmparser = karmem.NewReader(_Null_kmparser[:])
...
const (
	BlockTypeNone          BlockType = 0
	BlockTypeComponent     BlockType = 1
	BlockTypeStruct        BlockType = 2
	BlockTypeEnum          BlockType = 3
	BlockTypeComments      BlockType = 4
	BlockTypeFieldComments BlockType = 5
	BlockTypeField         BlockType = 6
)

const (
	PacketIdentifierComment         = 12677068775791051449
	PacketIdentifierMultiComment    = 5558992401289993760
	...
	PacketIdentifierBlock           = 11698454270780062994
...
func (x *Comment) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierComment
}

func (x *Comment) Reset() {
	x.Read((*CommentViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}

func (x *Comment) WriteAsRoot(writer karmem.Writer) (offset uint, err error) {
	return x.Write(writer, 0)
}

func (x *Comment) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(12)
	if offset == 0 {
	...
	writer.Write4At(offset+0, uint32(__ValueOffset))
	writer.Write4At(offset+0+4, uint32(__ValueSize))
...
func (*Comment) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(12)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.WriteAt(offset, _Null_kmparser[:size-4])
	__ValueOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+0, uint32(__ValueOffset))
	writer.Write4At(offset+0+4, 0)

	return offset, nil
}

func (x *Comment) ReadAsRoot(reader *karmem.Reader) {
	x.Read(NewCommentViewer(reader, 0), reader)
}

func (x *Comment) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewCommentViewer(reader, offset), reader)
}

func (x *Comment) Read(viewer *CommentViewer, reader *karmem.Reader) {
	if viewer == nil {
		return
	}
...
type MultiComment struct {
	Value []Comment
}

func NewMultiComment() MultiComment {
	return MultiComment{}
}

func (x *MultiComment) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierMultiComment
}

func (x *MultiComment) Reset() {
	x.Read((*MultiCommentViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}

func (x *MultiComment) WriteAsRoot(writer karmem.Writer) (offset uint, err error) {
	return x.Write(writer, 0)
}

func (x *MultiComment) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(8)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	__ValueSize := uint(12 * len(x.Value))
	__ValueOffset, err := writer.Alloc(__ValueSize)
	if err != nil {
		return 0, err
	}
	...
	writer.Write4At(offset+0+4, uint32(__ValueSize))
	for i := range x.Value {
		if _, err := x.Value[i].Write(writer, __ValueOffset); err != nil {
			return offset, err
		}
		__ValueOffset += 12
	}
...
func (*MultiComment) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(8)
	if offset == 0 {
		offset, err = writer.Alloc(size)
...
func (x *MultiComment) ReadAsRoot(reader *karmem.Reader) {
	x.Read(NewMultiCommentViewer(reader, 0), reader)
}

func (x *MultiComment) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewMultiCommentViewer(reader, offset), reader)
}

func (x *MultiComment) Read(viewer *MultiCommentViewer, reader *karmem.Reader) {
	if viewer == nil {
		return
	}
	...
	if __ValueLen > cap(x.Value) {
		x.Value = append(x.Value, make([]Comment, __ValueLen-len(x.Value))...)
	}
	if __ValueLen > len(x.Value) {
		x.Value = x.Value[:__ValueLen]
	}
	for i := 0; i < __ValueLen; i++ {
		x.Value[i].Read(&__ValueSlice[i], reader)
	}
	x.Value = x.Value[:__ValueLen]
}
...
func (x *Type) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierType
}

func (x *Type) Reset() {
	x.Read((*TypeViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*Type) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(34)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset, uint32(34))
	writer.WriteAt(offset, _Null_kmparser[:size-4])
	__SchemaOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+4, uint32(__SchemaOffset))
	writer.Write4At(offset+4+4, 0)
	__PlainSchemaOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+16, uint32(__PlainSchemaOffset))
...
func (x *Type) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewTypeViewer(reader, offset), reader)
}
...
func (x *PaddingType) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierPaddingType
}

func (x *PaddingType) Reset() {
	x.Read((*PaddingTypeViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*PaddingType) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(5)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+0, uint32(__DataOffset))
	if _, err := (*Type)(nil).WriteDefault(writer, __DataOffset); err != nil {
		return offset, err
	}
...
func (x *PaddingType) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewPaddingTypeViewer(reader, offset), reader)
}
...
func (x *Tag) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierTag
}

func (x *Tag) Reset() {
	x.Read((*TagViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*Tag) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(24)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.WriteAt(offset, _Null_kmparser[:size-4])
	__NameOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+0, uint32(__NameOffset))
...
func (x *Tag) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewTagViewer(reader, offset), reader)
}
...
func (x *StructSize) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierStructSize
}

func (x *StructSize) Reset() {
	x.Read((*StructSizeViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *StructSize) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	__TotalGroupSize := uint(5 * len(x.TotalGroup))
	...
	for i := range x.TotalGroup {
		...
		__TotalGroupOffset += 5
	}

	return offset, nil
}

func (*StructSize) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(28)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	__TotalOffset := offset + 16
	_ = __TotalOffset
	__TotalGroupOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+20, uint32(__TotalGroupOffset))
	writer.Write4At(offset+20+4, 0)
...
func (x *StructSize) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewStructSizeViewer(reader, offset), reader)
}
...
func (x *StructFieldSize) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierStructFieldSize
}

func (x *StructFieldSize) Reset() {
	x.Read((*StructFieldSizeViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*StructFieldSize) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(16)
	if offset == 0 {
		offset, err = writer.Alloc(size)
...
func (x *StructFieldSize) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewStructFieldSizeViewer(reader, offset), reader)
}
...
type EnumFieldData struct {
	...
	Value        string
	Tags         []Tag
	TopComments  MultiComment
	TailComments Comment
}
...
func (x *EnumFieldData) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierEnumFieldData
}

func (x *EnumFieldData) Reset() {
	x.Read((*EnumFieldDataViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *EnumFieldData) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	// struct size for table
	writer.Write4At(offset, uint32(58))
	__NameSize := uint(1 * len(x.Name))
	__NameOffset, err := writer.Alloc(__NameSize)
	if err != nil {
		return 0, err
	...
	__TopCommentsOffset := offset + 36
	if _, err := x.TopComments.Write(writer, __TopCommentsOffset); err != nil {
		return offset, err
	}
	__TailCommentsOffset := offset + 45
	if _, err := x.TailComments.Write(writer, __TailCommentsOffset); err != nil {
		return offset, err
	}
...
func (*EnumFieldData) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(58)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+16, uint32(__ValueOffset))
	writer.Write4At(offset+16+4, 0)
	__TagsOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+28, uint32(__TagsOffset))
	...
	__TopCommentsOffset := offset + 36
	_ = __TopCommentsOffset
	if _, err := (*MultiComment)(nil).WriteDefault(writer, __TopCommentsOffset); err != nil {
		return offset, err
	}
	__TailCommentsOffset := offset + 45
	_ = __TailCommentsOffset
	if _, err := (*Comment)(nil).WriteDefault(writer, __TailCommentsOffset); err != nil {
		return offset, err
	}
...
func (x *EnumFieldData) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewEnumFieldDataViewer(reader, offset), reader)
}
...
func (x *EnumFieldData) Read(viewer *EnumFieldDataViewer, reader *karmem.Reader) {
	...
	x.Tags = x.Tags[:__TagsLen]
	x.TopComments.Read(viewer.TopComments(), reader)
	x.TailComments.Read(viewer.TailComments(), reader)
}
...
func (x *EnumField) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierEnumField
}

func (x *EnumField) Reset() {
	x.Read((*EnumFieldViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*EnumField) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(5)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+0, uint32(__DataOffset))
	if _, err := (*EnumFieldData)(nil).WriteDefault(writer, __DataOffset); err != nil {
		return offset, err
	}
...
func (x *EnumField) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewEnumFieldViewer(reader, offset), reader)
}
...
func (x *EnumData) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierEnumData
}

func (x *EnumData) Reset() {
	x.Read((*EnumDataViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *EnumData) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	__FieldsSize := uint(5 * len(x.Fields))
	__FieldsOffset, err := writer.Alloc(__FieldsSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+21, uint32(__FieldsOffset))
	writer.Write4At(offset+21+4, uint32(__FieldsSize))
	...
	writer.Write4At(offset+29, uint32(__TagsOffset))
	writer.Write4At(offset+29+4, uint32(__TagsSize))
	for i := range x.Tags {
		if _, err := x.Tags[i].Write(writer, __TagsOffset); err != nil {
			return offset, err
		}
	...
	__TopCommentsOffset := offset + 37
	if _, err := x.TopComments.Write(writer, __TopCommentsOffset); err != nil {
		return offset, err
	}
	__TailCommentsOffset := offset + 46
	if _, err := x.TailComments.Write(writer, __TailCommentsOffset); err != nil {
		return offset, err
	}
	__IsSequentialOffset := offset + 59
	writer.Write1At(__IsSequentialOffset, *(*uint8)(unsafe.Pointer(&x.IsSequential)))

	return offset, nil
}

func (*EnumData) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(60)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	__TypeOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+16, uint32(__TypeOffset))
	if _, err := (*Type)(nil).WriteDefault(writer, __TypeOffset); err != nil {
		return offset, err
	}
	__FieldsOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+21, uint32(__FieldsOffset))
	writer.Write4At(offset+21+4, 0)
	__TagsOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+29, uint32(__TagsOffset))
	writer.Write4At(offset+29+4, 0)
	__TopCommentsOffset := offset + 37
	_ = __TopCommentsOffset
	if _, err := (*MultiComment)(nil).WriteDefault(writer, __TopCommentsOffset); err != nil {
		return offset, err
...
func (x *EnumData) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewEnumDataViewer(reader, offset), reader)
}
...
func (x *Enumeration) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierEnumeration
}

func (x *Enumeration) Reset() {
	x.Read((*EnumerationViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*Enumeration) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(5)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+0, uint32(__DataOffset))
	if _, err := (*EnumData)(nil).WriteDefault(writer, __DataOffset); err != nil {
		return offset, err
	}
...
func (x *Enumeration) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewEnumerationViewer(reader, offset), reader)
}
...
func (x *StructFieldData) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierStructFieldData
}

func (x *StructFieldData) Reset() {
	x.Read((*StructFieldDataViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *StructFieldData) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	writer.Write4At(offset+25, uint32(__TagsOffset))
	writer.Write4At(offset+25+4, uint32(__TagsSize))
	for i := range x.Tags {
		if _, err := x.Tags[i].Write(writer, __TagsOffset); err != nil {
			return offset, err
		}
	...
	writer.Write4At(offset+33, uint32(__SizeOffset))
	if _, err := x.Size.Write(writer, __SizeOffset); err != nil {
		return offset, err
	}
	__TopCommentsOffset := offset + 38
	if _, err := x.TopComments.Write(writer, __TopCommentsOffset); err != nil {
		return offset, err
	}
	__TailCommentsOffset := offset + 47
	if _, err := x.TailComments.Write(writer, __TailCommentsOffset); err != nil {
		return offset, err
	}
...
func (*StructFieldData) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(60)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+25, uint32(__TagsOffset))
	writer.Write4At(offset+25+4, 0)

	__SizeOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+33, uint32(__SizeOffset))
	if _, err := (*StructFieldSize)(nil).WriteDefault(writer, __SizeOffset); err != nil {
		return offset, err
	}
	__TopCommentsOffset := offset + 38
	_ = __TopCommentsOffset
...
func (x *StructFieldData) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewStructFieldDataViewer(reader, offset), reader)
}
...
func (x *StructField) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierStructField
}

func (x *StructField) Reset() {
	x.Read((*StructFieldViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*StructField) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(5)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+0, uint32(__DataOffset))
	if _, err := (*StructFieldData)(nil).WriteDefault(writer, __DataOffset); err != nil {
		return offset, err
	}
...
func (x *StructField) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewStructFieldViewer(reader, offset), reader)
}
...
func (x *Block) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierBlock
}

func (x *Block) Reset() {
	x.Read((*BlockViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *Block) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	__BlockTypeOffset := offset + 0
	writer.Write1At(__BlockTypeOffset, *(*uint8)(unsafe.Pointer(&x.BlockType)))
	__IndexOffset := offset + 1
	writer.Write4At(__IndexOffset, *(*uint32)(unsafe.Pointer(&x.Index)))

	return offset, nil
}

func (*Block) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(5)
	if offset == 0 {
		offset, err = writer.Alloc(size)
...
func (x *Block) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewBlockViewer(reader, offset), reader)
}
...
func (x *Block) Read(viewer *BlockViewer, reader *karmem.Reader) {
	...
	x.BlockType = BlockType(viewer.BlockType())
...
func (x *StructData) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierStructData
}

func (x *StructData) Reset() {
	x.Read((*StructDataViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *StructData) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	writer.Write4At(offset+29, uint32(__FieldsOffset))
	writer.Write4At(offset+29+4, uint32(__FieldsSize))
	for i := range x.Fields {
		if _, err := x.Fields[i].Write(writer, __FieldsOffset); err != nil {
			return offset, err
		}
	...
	__BlockSize := uint(5 * len(x.Block))
	__BlockOffset, err := writer.Alloc(__BlockSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+37, uint32(__BlockOffset))
	writer.Write4At(offset+37+4, uint32(__BlockSize))
	for i := range x.Block {
		if _, err := x.Block[i].Write(writer, __BlockOffset); err != nil {
			return offset, err
		}
		__BlockOffset += 5
	}
	__CommentsSize := uint(8 * len(x.Comments))
	__CommentsOffset, err := writer.Alloc(__CommentsSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+45, uint32(__CommentsOffset))
	writer.Write4At(offset+45+4, uint32(__CommentsSize))
	for i := range x.Comments {
		if _, err := x.Comments[i].Write(writer, __CommentsOffset); err != nil {
			return offset, err
		}
		__CommentsOffset += 8
	}
	__ClassOffset := offset + 53
	...
	writer.Write4At(offset+54, uint32(__TagsOffset))
	writer.Write4At(offset+54+4, uint32(__TagsSize))
	for i := range x.Tags {
		if _, err := x.Tags[i].Write(writer, __TagsOffset); err != nil {
			return offset, err
		}
	...
	__PackedOffset := offset + 62
	writer.Write1At(__PackedOffset, *(*uint8)(unsafe.Pointer(&x.Packed)))
	__IsComponentOffset := offset + 63
	writer.Write1At(__IsComponentOffset, *(*uint8)(unsafe.Pointer(&x.IsComponent)))

	return offset, nil
}

func (*StructData) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(64)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+24, uint32(__SizeOffset))
	if _, err := (*StructSize)(nil).WriteDefault(writer, __SizeOffset); err != nil {
		return offset, err
	}
	__FieldsOffset, err := writer.Alloc(0)
	if err != nil {
	...
	writer.Write4At(offset+29, uint32(__FieldsOffset))
	writer.Write4At(offset+29+4, 0)
	__BlockOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+37, uint32(__BlockOffset))
	writer.Write4At(offset+37+4, 0)
	__CommentsOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+45, uint32(__CommentsOffset))
	writer.Write4At(offset+45+4, 0)
	__ClassOffset := offset + 53
	_ = __ClassOffset
	__TagsOffset, err := writer.Alloc(0)
	if err != nil {
	...
	writer.Write4At(offset+54, uint32(__TagsOffset))
	writer.Write4At(offset+54+4, 0)
	__PackedOffset := offset + 62
	_ = __PackedOffset
	__IsComponentOffset := offset + 63
	_ = __IsComponentOffset
...
func (x *StructData) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewStructDataViewer(reader, offset), reader)
}
...
func (x *StructData) Read(viewer *StructDataViewer, reader *karmem.Reader) {
	...
	x.Fields = x.Fields[:__FieldsLen]
	__BlockSlice := viewer.Block(reader)
	__BlockLen := len(__BlockSlice)
	if __BlockLen > cap(x.Block) {
		x.Block = append(x.Block, make([]Block, __BlockLen-len(x.Block))...)
	}
	if __BlockLen > len(x.Block) {
		x.Block = x.Block[:__BlockLen]
	}
	for i := 0; i < __BlockLen; i++ {
		x.Block[i].Read(&__BlockSlice[i], reader)
	}
	x.Block = x.Block[:__BlockLen]
	__CommentsSlice := viewer.Comments(reader)
	__CommentsLen := len(__CommentsSlice)
	if __CommentsLen > cap(x.Comments) {
		x.Comments = append(x.Comments, make([]MultiComment, __CommentsLen-len(x.Comments))...)
	}
	if __CommentsLen > len(x.Comments) {
		x.Comments = x.Comments[:__CommentsLen]
	}
	for i := 0; i < __CommentsLen; i++ {
		x.Comments[i].Read(&__CommentsSlice[i], reader)
	}
	x.Comments = x.Comments[:__CommentsLen]
	...
	x.IsComponent = viewer.IsComponent()
}
...
func (x *Structure) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierStructure
}

func (x *Structure) Reset() {
	x.Read((*StructureViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*Structure) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(5)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+0, uint32(__DataOffset))
	if _, err := (*StructData)(nil).WriteDefault(writer, __DataOffset); err != nil {
		return offset, err
	}
...
func (x *Structure) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewStructureViewer(reader, offset), reader)
}
...
func (x *ContentSize) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierContentSize
}

func (x *ContentSize) Reset() {
	x.Read((*ContentSizeViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*ContentSize) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(8)
	if offset == 0 {
		offset, err = writer.Alloc(size)
...
func (x *ContentSize) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewContentSizeViewer(reader, offset), reader)
}
...
func (x *ContentOptions) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierContentOptions
}

func (x *ContentOptions) Reset() {
	x.Read((*ContentOptionsViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (*ContentOptions) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(40)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset, uint32(40))
	writer.WriteAt(offset, _Null_kmparser[:size-4])
	__ModuleOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+4, uint32(__ModuleOffset))
	writer.Write4At(offset+4+4, 0)
	__ImportOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+16, uint32(__ImportOffset))
	writer.Write4At(offset+16+4, 0)
	__PrefixOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+28, uint32(__PrefixOffset))
...
func (x *ContentOptions) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewContentOptionsViewer(reader, offset), reader)
}
...
func (x *Content) PacketIdentifier() karmem.PacketIdentifier {
	return PacketIdentifierContent
}

func (x *Content) Reset() {
	x.Read((*ContentViewer)(unsafe.Pointer(&_Null_kmparser[0])), _NullReader_kmparser)
}
...
func (x *Content) Write(writer karmem.Writer, start uint) (offset uint, err error) {
	...
	// struct size for table
	writer.Write4At(offset, uint32(63))
	__CommentsSize := uint(8 * len(x.Comments))
	__CommentsOffset, err := writer.Alloc(__CommentsSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+4, uint32(__CommentsOffset))
	writer.Write4At(offset+4+4, uint32(__CommentsSize))
	for i := range x.Comments {
		if _, err := x.Comments[i].Write(writer, __CommentsOffset); err != nil {
			return offset, err
		}
	...
	writer.Write4At(offset+12, uint32(__TagsOffset))
	writer.Write4At(offset+12+4, uint32(__TagsSize))
	for i := range x.Tags {
		if _, err := x.Tags[i].Write(writer, __TagsOffset); err != nil {
			return offset, err
		}
	...
	__StructsSize := uint(5 * len(x.Structs))
	__StructsOffset, err := writer.Alloc(__StructsSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+20, uint32(__StructsOffset))
	writer.Write4At(offset+20+4, uint32(__StructsSize))
	...
	__BlocksSize := uint(5 * len(x.Blocks))
	__BlocksOffset, err := writer.Alloc(__BlocksSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+28, uint32(__BlocksOffset))
	writer.Write4At(offset+28+4, uint32(__BlocksSize))
	for i := range x.Blocks {
		if _, err := x.Blocks[i].Write(writer, __BlocksOffset); err != nil {
			return offset, err
		}
		__BlocksOffset += 5
	}
	__EnumsSize := uint(5 * len(x.Enums))
	__EnumsOffset, err := writer.Alloc(__EnumsSize)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+36, uint32(__EnumsOffset))
	writer.Write4At(offset+36+4, uint32(__EnumsSize))
	for i := range x.Enums {
	...
	writer.Write4At(offset+44, uint32(__SizeOffset))
	if _, err := x.Size.Write(writer, __SizeOffset); err != nil {
		return offset, err
	}
	__NameSize := uint(1 * len(x.Name))
	...
	writer.Write4At(offset+49, uint32(__NameOffset))
	writer.Write4At(offset+49+4, uint32(__NameSize))
	__NameSlice := [3]uint{*(*uint)(unsafe.Pointer(&x.Name)), __NameSize, __NameSize}
	writer.WriteAt(__NameOffset, *(*[]byte)(unsafe.Pointer(&__NameSlice)))
	__PackedOffset := offset + 61
	writer.Write1At(__PackedOffset, *(*uint8)(unsafe.Pointer(&x.Packed)))
	__HasComponentOffset := offset + 62
	writer.Write1At(__HasComponentOffset, *(*uint8)(unsafe.Pointer(&x.HasComponent)))

	return offset, nil
}

func (*Content) WriteDefault(writer karmem.Writer, start uint) (offset uint, err error) {
	offset = start
	size := uint(63)
	if offset == 0 {
		offset, err = writer.Alloc(size)
	...
	writer.Write4At(offset+12, uint32(__TagsOffset))
	writer.Write4At(offset+12+4, 0)
	__StructsOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+20, uint32(__StructsOffset))
	writer.Write4At(offset+20+4, 0)
	__BlocksOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+28, uint32(__BlocksOffset))
	writer.Write4At(offset+28+4, 0)
	__EnumsOffset, err := writer.Alloc(0)
	if err != nil {
		return 0, err
	}
	writer.Write4At(offset+36, uint32(__EnumsOffset))
	writer.Write4At(offset+36+4, 0)
	...
	writer.Write4At(offset+44, uint32(__SizeOffset))
	if _, err := (*ContentSize)(nil).WriteDefault(writer, __SizeOffset); err != nil {
		return offset, err
	}
	__NameOffset, err := writer.Alloc(0)
	if err != nil {
	...
	writer.Write4At(offset+49, uint32(__NameOffset))
	writer.Write4At(offset+49+4, 0)
	__PackedOffset := offset + 61
	_ = __PackedOffset
	__HasComponentOffset := offset + 62
	_ = __HasComponentOffset
...
func (x *Content) ReadWithOffset(reader *karmem.Reader, offset uint32) {
	x.Read(NewContentViewer(reader, offset), reader)
}
...
func (x *Content) Read(viewer *ContentViewer, reader *karmem.Reader) {
	...
	x.Structs = x.Structs[:__StructsLen]
	__BlocksSlice := viewer.Blocks(reader)
	__BlocksLen := len(__BlocksSlice)
	if __BlocksLen > cap(x.Blocks) {
		x.Blocks = append(x.Blocks, make([]Block, __BlocksLen-len(x.Blocks))...)
	}
	if __BlocksLen > len(x.Blocks) {
		x.Blocks = x.Blocks[:__BlocksLen]
	}
	for i := 0; i < __BlocksLen; i++ {
		x.Blocks[i].Read(&__BlocksSlice[i], reader)
	}
	x.Blocks = x.Blocks[:__BlocksLen]
	...
	x.Packed = viewer.Packed()
	x.HasComponent = viewer.HasComponent()
}

type CommentViewer [12]byte

func NewCommentViewer(reader *karmem.Reader, offset uint32) (v *CommentViewer) {
	if !reader.IsValidOffset(offset, 12) {
		return (*CommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	v = (*CommentViewer)(unsafe.Add(reader.Pointer, offset))
	return v
}

func (x *CommentViewer) size() uint32 {
	return 12
}

func (x *CommentViewer) Value(reader *karmem.Reader) (v string) {
...
type MultiCommentViewer [8]byte

func NewMultiCommentViewer(reader *karmem.Reader, offset uint32) (v *MultiCommentViewer) {
	if !reader.IsValidOffset(offset, 8) {
		return (*MultiCommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	v = (*MultiCommentViewer)(unsafe.Add(reader.Pointer, offset))
	return v
}

func (x *MultiCommentViewer) size() uint32 {
	return 8
}

func (x *MultiCommentViewer) Value(reader *karmem.Reader) (v []CommentViewer) {
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 0))
	size := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 0+4))
	if !reader.IsValidOffset(offset, size) {
	...
	return *(*[]CommentViewer)(unsafe.Pointer(&slice))
}

type TypeViewer [34]byte

func NewTypeViewer(reader *karmem.Reader, offset uint32) (v *TypeViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*TypeViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *TypeViewer) Length() (v uint32) {
	...
	return *(*uint32)(unsafe.Add(unsafe.Pointer(x), 28))
}
...
func (x *TypeViewer) Format() (v TypeFormat) {
	...
	return *(*TypeFormat)(unsafe.Add(unsafe.Pointer(x), 32))
}
...
func (x *TypeViewer) Model() (v TypeModel) {
	...
	return *(*TypeModel)(unsafe.Add(unsafe.Pointer(x), 33))
}

type PaddingTypeViewer [5]byte

func NewPaddingTypeViewer(reader *karmem.Reader, offset uint32) (v *PaddingTypeViewer) {
	if !reader.IsValidOffset(offset, 5) {
		return (*PaddingTypeViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func NewStructSizeViewer(reader *karmem.Reader, offset uint32) (v *StructSizeViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*StructSizeViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func NewStructFieldSizeViewer(reader *karmem.Reader, offset uint32) (v *StructFieldSizeViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*StructFieldSizeViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
type EnumFieldDataViewer [58]byte

func NewEnumFieldDataViewer(reader *karmem.Reader, offset uint32) (v *EnumFieldDataViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*EnumFieldDataViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *EnumFieldDataViewer) TopComments() (v *MultiCommentViewer) {
	if 36+8 > x.size() {
		return (*MultiCommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	return (*MultiCommentViewer)(unsafe.Add(unsafe.Pointer(x), 36))
}

func (x *EnumFieldDataViewer) TailComments() (v *CommentViewer) {
	if 45+12 > x.size() {
		return (*CommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	return (*CommentViewer)(unsafe.Add(unsafe.Pointer(x), 45))
}

type EnumFieldViewer [5]byte

func NewEnumFieldViewer(reader *karmem.Reader, offset uint32) (v *EnumFieldViewer) {
	if !reader.IsValidOffset(offset, 5) {
		return (*EnumFieldViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
type EnumDataViewer [60]byte

func NewEnumDataViewer(reader *karmem.Reader, offset uint32) (v *EnumDataViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*EnumDataViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *EnumDataViewer) Fields(reader *karmem.Reader) (v []EnumFieldViewer) {
	...
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 21))
	size := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 21+4))
	if !reader.IsValidOffset(offset, size) {
		return []EnumFieldViewer{}
	}
	length := uintptr(size / 5)
...
func (x *EnumDataViewer) TopComments() (v *MultiCommentViewer) {
	if 37+8 > x.size() {
		return (*MultiCommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	return (*MultiCommentViewer)(unsafe.Add(unsafe.Pointer(x), 37))
}

func (x *EnumDataViewer) TailComments() (v *CommentViewer) {
	if 46+12 > x.size() {
		return (*CommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	return (*CommentViewer)(unsafe.Add(unsafe.Pointer(x), 46))
}
...
func (x *EnumDataViewer) IsSequential() (v bool) {
	...
	return *(*bool)(unsafe.Add(unsafe.Pointer(x), 59))
}

type EnumerationViewer [5]byte

func NewEnumerationViewer(reader *karmem.Reader, offset uint32) (v *EnumerationViewer) {
	if !reader.IsValidOffset(offset, 5) {
		return (*EnumerationViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
type StructFieldDataViewer [60]byte

func NewStructFieldDataViewer(reader *karmem.Reader, offset uint32) (v *StructFieldDataViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*StructFieldDataViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *StructFieldDataViewer) Offset() (v uint32) {
	...
	return *(*uint32)(unsafe.Add(unsafe.Pointer(x), 21))
}
...
func (x *StructFieldDataViewer) Tags(reader *karmem.Reader) (v []TagViewer) {
	...
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 25))
	size := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 25+4))
	if !reader.IsValidOffset(offset, size) {
		return []TagViewer{}
	}
	length := uintptr(size / 24)
...
func (x *StructFieldDataViewer) TopComments() (v *MultiCommentViewer) {
	if 38+8 > x.size() {
		return (*MultiCommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	return (*MultiCommentViewer)(unsafe.Add(unsafe.Pointer(x), 38))
}

func (x *StructFieldDataViewer) TailComments() (v *CommentViewer) {
	if 47+12 > x.size() {
		return (*CommentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
	return (*CommentViewer)(unsafe.Add(unsafe.Pointer(x), 47))
}

type StructFieldViewer [5]byte

func NewStructFieldViewer(reader *karmem.Reader, offset uint32) (v *StructFieldViewer) {
	if !reader.IsValidOffset(offset, 5) {
		return (*StructFieldViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
type BlockViewer [5]byte

func NewBlockViewer(reader *karmem.Reader, offset uint32) (v *BlockViewer) {
	if !reader.IsValidOffset(offset, 5) {
		return (*BlockViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *BlockViewer) BlockType() (v BlockType) {
	return *(*BlockType)(unsafe.Add(unsafe.Pointer(x), 0))
}

func (x *BlockViewer) Index() (v int32) {
	return *(*int32)(unsafe.Add(unsafe.Pointer(x), 1))
}

type StructDataViewer [64]byte

func NewStructDataViewer(reader *karmem.Reader, offset uint32) (v *StructDataViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*StructDataViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *StructDataViewer) Block(reader *karmem.Reader) (v []BlockViewer) {
	if 37+8 > x.size() {
		return []BlockViewer{}
	}
	...
	return *(*[]BlockViewer)(unsafe.Pointer(&slice))
}

func (x *StructDataViewer) Comments(reader *karmem.Reader) (v []MultiCommentViewer) {
	if 45+8 > x.size() {
		return []MultiCommentViewer{}
	}
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 45))
	size := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 45+4))
	if !reader.IsValidOffset(offset, size) {
		return []MultiCommentViewer{}
	}
	...
	return *(*[]MultiCommentViewer)(unsafe.Pointer(&slice))
}
...
func (x *StructDataViewer) Class() (v StructClass) {
	...
	return *(*StructClass)(unsafe.Add(unsafe.Pointer(x), 53))
}
...
func (x *StructDataViewer) Tags(reader *karmem.Reader) (v []TagViewer) {
	...
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 54))
	size := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 54+4))
	if !reader.IsValidOffset(offset, size) {
		return []TagViewer{}
	}
	length := uintptr(size / 24)
...
func (x *StructDataViewer) Packed() (v bool) {
	...
	return *(*bool)(unsafe.Add(unsafe.Pointer(x), 62))
}

func (x *StructDataViewer) IsComponent() (v bool) {
	if 63+1 > x.size() {
		return v
	}
	return *(*bool)(unsafe.Add(unsafe.Pointer(x), 63))
}

type StructureViewer [5]byte

func NewStructureViewer(reader *karmem.Reader, offset uint32) (v *StructureViewer) {
	if !reader.IsValidOffset(offset, 5) {
		return (*StructureViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func NewContentSizeViewer(reader *karmem.Reader, offset uint32) (v *ContentSizeViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*ContentSizeViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
type ContentOptionsViewer [40]byte

func NewContentOptionsViewer(reader *karmem.Reader, offset uint32) (v *ContentOptionsViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*ContentOptionsViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
type ContentViewer [63]byte

func NewContentViewer(reader *karmem.Reader, offset uint32) (v *ContentViewer) {
	if !reader.IsValidOffset(offset, 4) {
		return (*ContentViewer)(unsafe.Pointer(&_Null_kmparser[0]))
	}
...
func (x *ContentViewer) Comments(reader *karmem.Reader) (v []MultiCommentViewer) {
	if 4+8 > x.size() {
		return []MultiCommentViewer{}
	}
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 4))
...
func (x *ContentViewer) Blocks(reader *karmem.Reader) (v []BlockViewer) {
	if 28+8 > x.size() {
		return []BlockViewer{}
	}
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 28))
...
func (x *ContentViewer) Size(reader *karmem.Reader) (v *ContentSizeViewer) {
	...
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 44))
...
func (x *ContentViewer) Name(reader *karmem.Reader) (v string) {
	...
	offset := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 49))
	size := *(*uint32)(unsafe.Add(unsafe.Pointer(x), 49+4))
	if !reader.IsValidOffset(offset, size) {
		return ""
	}
	length := uintptr(size / 1)
...
func (x *ContentViewer) Packed() (v bool) {
	...
	return *(*bool)(unsafe.Add(unsafe.Pointer(x), 61))
}

func (x *ContentViewer) HasComponent() (v bool) {
	if 62+1 > x.size() {
		return v
	}
	return *(*bool)(unsafe.Add(unsafe.Pointer(x), 62))
